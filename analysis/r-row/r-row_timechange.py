...
def plot2(r_list, dens_list, args):
  fig = plt.figure()
  mpl.rcParams['agg.path.chunksize'] = 10000

  plt.plot(r_list[0], dens_list[0], '.', ms=0.5)
  plt.plot(r_list[1], dens_list[1], '.', ms=0.5)
